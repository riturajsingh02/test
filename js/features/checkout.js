...
async function processOrder(e) {
  ...
  const activeCodes = [];
  if (appliedCouponCode) activeCodes.push(appliedCouponCode);
  ...
  showToast(`Checkout is ready for ₹${totals.finalTotal.toLocaleString('en-IN')}. Connect the Shopify Storefront token to enable live checkout.`);
}
